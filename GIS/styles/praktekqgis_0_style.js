...
var style_praktekqgis_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Jmlh Pnddk");
    var labelText = "";
    size = 0;
    ...
    if (value > 24805.000000 && value <= 38599.800000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 38599.800000 && value <= 52394.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 52394.600000 && value <= 66189.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 66189.400000 && value <= 79984.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 79984.200000 && value <= 93779.000000) {
            style = [ new ol.style.Style({
